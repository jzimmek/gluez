    ...
    this.resource = function(type, fun, resourceOpts){
      ...
      this[type] = function(name, opts){
        ...
        pluginEntry.functionName = function(){
          var name =  this.type + "_" + (resourceOpts.name||this.name).replace(/~/g, "").replace(/\//g, "").replace(/\./g, "").replace(/ /g, "").replace(/-/g, "_").replace(/:/g, "").replace(/#/g, "");
        ...
        pluginEntry.resourceName = function(){
          var name = this.type + ":" + (resourceOpts.name||this.name);
          if(this.asUser != "root")
